              ...
              <>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ marginBottom: 3, display: "flex", alignItems: "center", gap: 5 }}>
                    ...
                    {saldoApos <= 0 && (
                      <span style={{ flexShrink: 0, fontSize: 9, fontWeight: 800, color: "#fff", background: "#7c3aed", borderRadius: 4, padding: "1px 5px", letterSpacing: 0.5, textTransform: "uppercase" }}>QUITADO</span>
                    )}
                  </div>
                  <div style={{ display: "flex", gap: 14, alignItems: "center" }}>
                    ...
                    <span style={{ fontSize: 11, color: P.textSecondary }}>
                      Saldo: <strong style={{ color: saldoApos <= 0 ? "#7c3aed" : P.accent, fontWeight: 700 }}>R$ {saldoApos.toFixed(2)}</strong>
                    </span>
                  </div>
                </div>
                {/* Dot */}
