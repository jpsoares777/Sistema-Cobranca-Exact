              ...
              <div key={d.id}>
                <div style={{ display: "flex", alignItems: "center", padding: "5px 12px", fontSize: 12, backgroundColor: expandido ? "#FFF8F8" : "white" }}>
                  ...
                  <button onClick={() => { if (confirm("Excluir esta despesa?")) { onDelete?.(d.id); if (aberto === d.id) setAberto(null); } }}
                    style={{ width: 34, height: 30, display: "flex", alignItems: "center", justifyContent: "center", background: "#FFEBEE", border: "1px solid #FFCDD2", borderRadius: 6, cursor: "pointer", color: "#C62828", flexShrink: 0 }}>
                    <Trash2 size={15} />
                  </button>
                </div>
                {expandido && (
              ...
              <div key={r.id}>
                <div style={{ display: "flex", alignItems: "center", padding: "5px 12px", fontSize: 12, backgroundColor: expandido ? "#F1F8E9" : "white" }}>
                  ...
                  <button onClick={() => { if (confirm("Excluir este rendimento?")) { onDelete?.(r.id); if (aberto === r.id) setAberto(null); } }}
                    style={{ width: 34, height: 30, display: "flex", alignItems: "center", justifyContent: "center", background: "#F1F8E9", border: "1px solid #C8E6C9", borderRadius: 6, cursor: "pointer", color: "#2E7D32", flexShrink: 0 }}>
                    <Trash2 size={15} />
                  </button>
                </div>
                {expandido && (
