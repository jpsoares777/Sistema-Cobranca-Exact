...
import { ClienteDetalhe, ClienteDetalheRenovacao, ClienteItem, Agendamento } from "./ClienteDetalhe";
  ...
  return (
    <div style={{
      ...
      {verAusentes
        ...
        : activeNav === 1 ? <CadastroCliente onBack={() => setActiveNav(0)} onSalvar={(emp) => { setEmprestimentos(prev => [emp, ...prev]); }} />
